# Project Introduction and Selection

## Learning Overview

This week, I had to choose a website to redesign or rebuild.

## Selection Process

I started with brainstorming, covering websites I knew already and exploring new businesses. I also considered what I wanted out of the project, which I will cover under the _Why did you choose this?_ section.

I relied on internet searches the most, looking for local businesses. I prefer to work on concepts that relate to my life, so for the most part, I looked within the Vancouver area.

## Chosen websites

The [City of Vancouver](https://vancouver.ca/) information website.
...
I wanted to find a website that was sufficiently challenging, that looked good to untrained eyes but had problems I could see and solve. I've taken graphic design courses before, and as such have some knowledge when it comes to that area. Having done similar redesigning projects in the past, I didn't want to pick a website that had such a poor design that anyone could pick it out.

My portfolio already has projects of varying topics, such as creating branding and style guides, overhauling existing UI (User Interface), and creating UI from scratch. The brands I previously chose for overhauls were mostly small businesses. I like to show variety in my work, so I felt it'd be best I choose a larger scale, more professionally made project to show off more of my skills.
